...
add_action( 'after_setup_theme', 'jenscores_custom_header_setup' );

if ( ! function_exists( 'jenscores_header_style' ) ) :
/**
 * Styles the header image and text displayed on the blog.
 *
 * @see jenscores_custom_header_setup().
 */
function jenscores_header_style() {
